# -*- coding: utf-8 -*-
"""Refresh schools/_collection.json DERIVED fields from the actual grammar files.

The grammars are the source of truth; this re-syncs each registry entry's name, type,
items count, cover_image_url, default_preview and blurb from schools/<slug>/grammar.json.
