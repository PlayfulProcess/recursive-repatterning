...
deck grammar.json files already in this repo (schools/<slug>/grammar.json).
...
Output: schools/all-schools-many-lenses/grammar.json (a self-contained grammar whose
...
#     stub (`schools/<slug>/grammar.json` has exactly one item, category="overview", zero
...
#     grammar (Recovery/Escape/Fantasy), not even registered in schools/_collection.json.
DECKS = {
...
def build():
    ...
    grammar = {
        ...
        "description": (
            ...
            "`schools/<slug>/grammar.json`. This meta is a *generated index* (a projection) over those decks, "
