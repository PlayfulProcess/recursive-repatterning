...
rws = {
    "_github_url": "https://github.com/PlayfulProcess/recursive-tarot/blob/main/schools/%s/grammar.json" % RWS_NEW,
    "_github_source_url": "https://raw.githubusercontent.com/PlayfulProcess/recursive-tarot/main/schools/%s/grammar.json" % RWS_NEW,
    "_grammar_commons": {
        "schema_version": "1.0",
...
papus = {
    "_github_url": "https://github.com/PlayfulProcess/recursive-tarot/blob/main/schools/%s/grammar.json" % PAPUS_NEW,
    "_github_source_url": "https://raw.githubusercontent.com/PlayfulProcess/recursive-tarot/main/schools/%s/grammar.json" % PAPUS_NEW,
    "_grammar_commons": {
        "schema_version": "1.0",
        "license": "CC-BY-SA-4.0",
        "attribution": [
