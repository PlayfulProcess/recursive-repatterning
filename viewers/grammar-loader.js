 ...
 * (deck slug, or app UUID via schools/_eco_ids.json) and never reach this path.
...
(function() {
     ...
     * @param {string} path - Short path like "schools/rider-waite"
     * @returns {boolean}
     */
    ...
    function parseCommunityUrl(url) {
        ...
        // e.g., https://raw.githubusercontent.com/.../main/schools/rider-waite/grammar.json
        // e.g., https://raw.githubusercontent.com/.../main/schools/rider-waite
     ...
     * @param {string} path - Short path like "schools/rider-waite" or "schools/rider-waite/grammar.json"
